...
\path (1) edge [bend right = -25] node[below =0.15 cm] {$10/10$} (2); 
\path (1) edge [bend right = -25] node[below =0.15 cm] {$8/20$} (3); 
\path (1) edge [bend right = -25] node[below =0.15 cm] {$10/10$} (4); 
\path (1) edge [bend right = -25] node[below =0.15 cm] {$10/10$} (5); 
...
\path (8) edge [bend right = -25] node[below =0.15 cm] {$8/20$} (10); 
\path (9) edge [bend right = -25] node[below =0.15 cm] {$10/10$} (10); 
\end{tikzpicture}
\end{center}
\end{landscape}
\end{document}