...
%% ---------------------------------------------------------------------
        ...
        for k=2:nombre_objets
            ...
            if nbrecollision(k) > 0
                ...
                poids_n_pt_c = T(1).nurbs.coefs(4,iref) * 1000; % Il faut donner un poids fort au nouveau pt de controle issu de la collisuon
                %
                T(1).nurbs.coefs(1,iref+1:nbre_pts_controle + 1) = T(1).nurbs.coefs(1,iref:nbre_pts_controle);
                T(1).nurbs.coefs(2,iref+1:nbre_pts_controle + 1) = T(1).nurbs.coefs(2,iref:nbre_pts_controle);
                T(1).nurbs.coefs(3,:) = 0;
                T(1).nurbs.coefs(4,iref+1:nbre_pts_controle + 1) =  T(1).nurbs.coefs(4,iref:nbre_pts_controle);
                %
